...
function Skillbar() {
  return (
    <>
      ...
      >
        <h3 className="text-xl md:text-2xl text-center antialiased tracking-wide">
          Basic of{' '}
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.6, delay: 0.2 }}
        className="relative rounded-md p-4 px-8 leading-relaxed shadow-lg rounded-8"
      >
        <div className="w-full ">
          <span className="block font-medium antialiased">
            <p className="skillBarTitle font-semibold ">
              {' '}
              HTML{' '}
            </p>
          </span>
          <div className="relative h-2 w-full rounded-md mt-2 ">
            <motion.span
        ...
        <div className=" w-full my-6">
          ...
          <div className=" h-2 w-full rounded-md mt-2 ">
            <motion.span
              initial={{ width: 0, opacity: 0 }}
              whileInView={{ width: '80%', opacity: 1 }}
              viewport={{ once: true }}
